          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="p-12 lg:p-16 flex flex-col justify-center">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                ...
                Create a group to meet people, learn new things, find support, get out of your comfort zone, 
                and pursue your passions, together.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700 text-lg">Easy group management tools</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-4">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700 text-lg">Built-in event planning</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-4">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative lg:h-auto h-64">
              <img 
                src="https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
              ...
              <div className="absolute top-8 left-8 bg-white rounded-2xl p-4 shadow-xl">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Group organizers</div>
                  </div>
                </div>
              </div>
